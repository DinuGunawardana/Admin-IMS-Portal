...
<body>
  <?php if($results): ?>
    ...
    <div class="page-break">
       <div class="sale-head pull-left" style="margin-left: 250px;">
           <h1>Sales Report</h1>
  ...
  <script src="libs/js/jspdf.js"></script>
  <script src="libs/js/jquery-2.1.3.js"></script>
  <script src="libs/js/pdfFromHTML.js"></script>
<a href="#" onclick="HTMLtoPDF()" class="btn btn-danger" style="margin-left: 250px;">Download PDF</a><br/>
